...
UArizona HPC systems are available to all university faculty, staff, undergraduate and graduate students, postdocs, and designated campus colleagues (DCCs) at no cost. Researchers have access to [compute resources on our two clusters](./resources/compute_resources/), Ocelote and Puma, located in our data center. Presently each research group is provided with a [free standard monthly allocation](./resources/allocations/) on each: 150,000 CPU-hours on Puma and 100,000 CPU-hours on Ocelote.
...
-   :material-server-off:{ .lg .middle } __Clusters Decommissioning__
