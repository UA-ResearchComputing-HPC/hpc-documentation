...
|-|-|
|Traditional machine learning / deep learning|:material-check-circle-outline:{ .lg .ballow } Permitted|
|LLM inference and chatbots|:material-check-circle-outline:{ .lg .ballow } Permitted|
|AI coding assistant that suggests or edits code under user supervision|:material-check-circle-outline:{ .lg .ballow } Permitted|
|Agent executing commands with explicit user review and approval|:fontawesome-solid-triangle-exclamation:{ .lg .ycaution } Permitted with restrictions|
|Agent independently submitting or operating HPC jobs|:material-cancel:{ .lg .rforbidden } Prohibited|
|Unattended agent controlling system commands, files, or HPC resources|:material-cancel:{ .lg .rforbidden } Prohibited|
|Autonomous iterative AI workflows|:material-cancel:{ .lg .rforbidden } Prohibited|
|Autonomous spawning or operation of subagents|:material-cancel:{ .lg .rforbidden } Prohibited|
|Computationally intensive agent activity on login nodes|:material-cancel:{ .lg .rforbidden } Prohibited|
|Unsupervised destructive or high-impact system/file operations|:material-cancel:{ .lg .rforbidden } Prohibited|
